...
import {
  ...
  usePiPWindow
} from "./chunk-6PBH6WQF.js";
import {
  createStore
} from "./chunk-XFFA5NHP.js";
import {
  Portal,
  addEventListener,
  classList,
...
// node_modules/@tanstack/devtools/dist/devtools/7NDEDZB7.js
var useDraw = (props) => {
...
var _tmpl$ = template(`<button type=button aria-label="Open TanStack Devtools"><img alt="TanStack Devtools">`);
var Trigger = ({
  isOpen,
  setIsOpen,
...
var _tmpl$22 = template(`<div><div></div>Final shortcut is: `);
var _tmpl$32 = template(`<div><div>`);
var SettingsTab = () => {
  const {
    setSettings,
    settings
...
var _tmpl$5 = template(`<div>New`);
var _tmpl$23 = template(`<img>`);
var _tmpl$33 = template(`<span>✓ v<!> • Min v`);
var _tmpl$42 = template(`<p>`);
var _tmpl$52 = template(`<a target=_blank rel="noopener noreferrer">Documentation `);
var _tmpl$6 = template(`<div>`);
var _tmpl$7 = template(`<div><span></span><div></div><div><h3></h3><p></p><p>`);
var _tmpl$8 = template(`<span>⚠️ v<!> • Requires v<!>+`);
var _tmpl$9 = template(`<span>`);
var _tmpl$0 = template(`<span>Installing...`);
var _tmpl$1 = template(`<span>Installed!`);
    ...
    insert(_el$6, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$0, createComponent(Show, {
          ...
          get fallback() {
            return (() => {
              var _el$16 = _tmpl$8(), _el$17 = _el$16.firstChild, _el$20 = _el$17.nextSibling, _el$18 = _el$20.nextSibling, _el$21 = _el$18.nextSibling;
              _el$21.nextSibling;
          ...
          get children() {
            var _el$1 = _tmpl$33(), _el$10 = _el$1.firstChild, _el$12 = _el$10.nextSibling;
            _el$12.nextSibling;
...
var _tmpl$10 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=currentColor><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z">`);
var _tmpl$24 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><rect x=2 y=4 width=20 height=16 rx=2></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7">`);
...
var _tmpl$53 = template(`<div><div><div><div></div><h3>`);
...
delegateEvents(["click"]);
var _tmpl$11 = template(`<div><div><h3>Marketplace Settings</h3><button></button></div><div>`);
...
delegateEvents(["click"]);
var _tmpl$12 = template(`<div>`);
var _tmpl$25 = template(`<button>`);
...
delegateEvents(["click"]);
var _tmpl$13 = template(`<div><div><h2>Plugin Marketplace</h2><div><div><input type=text placeholder="Search plugins..."></div><button></button></div></div><p>Discover and install devtools for TanStack Query, Router, Form, and Pacer`);
...
var _tmpl$15 = template(`<div><div><div><div></div><div><h3>Add More`);
var _tmpl$27 = template(`<div><h3>`);
var _tmpl$35 = template(`<div>`);
var PluginsTab = () => {
  const {
    plugins,
    activePlugins,
...
var _tmpl$16 = template(`<div><div> Preview</div><div></div><div></div><div>`);
var _tmpl$28 = template(`<img alt=Preview>`);
var _tmpl$36 = template(`<div>No Image`);
var _tmpl$44 = template(`<div>`);
var _tmpl$54 = template(`<div><strong>Missing tags for <!>:</strong><ul>`);
var _tmpl$62 = template(`<li>`);
var SOCIALS = [
  {
    network: "Facebook",
    tags: [{
              ...
              children: (report, i) => {
                ...
                return (() => {
                  ...
                  insert(_el$0, (() => {
                    ...
                    return () => _c$2() ? (() => {
                      var _el$1 = _tmpl$54(), _el$10 = _el$1.firstChild, _el$11 = _el$10.firstChild, _el$13 = _el$11.nextSibling;
                      _el$13.nextSibling;
...
var _tmpl$17 = template(`<div>`);
var _tmpl$29 = template(`<button type=button>`);
var _tmpl$37 = template(`<div><button type=button></button><button type=button>`);
var Tabs = (props) => {
  const styles = useStyles();
  const {
    state,
...
var SourceInspector = () => {
  ...
  const isHighlightingKeysHeld = createMemo(() => {
    const keys2 = downList();
    const isShiftHeld = keys2.includes("SHIFT");
    const isCtrlHeld = keys2.includes("CONTROL");
    const isMetaHeld = keys2.includes("META");
...
//# sourceMappingURL=7NDEDZB7-FTUAE3R5.js.map
